...
int main(void) {
	...
	FILE* downsample_image_r = fopen("./downsample/BasketballDrill_416x240_yuv420_8bit_frame360.yuv", "rb"); // downsample된 8-bit image의 픽셀값을 배열에 저장
	...
	FILE* reconstructed_image_w = fopen("./upsample/BasketballDrill_832x480_yuv420_8bit_frame360.yuv", "wb"); // upsample된 8-bit image를 .yuv 포맷 파일로 저장
